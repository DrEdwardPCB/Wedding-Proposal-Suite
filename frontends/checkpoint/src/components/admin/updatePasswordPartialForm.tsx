...
import {
    IUpdatePasswordPartialDto,
    VUpdatePasswordPartialDto,
} from "../../apis/admin";
...
import { PasswordPartial } from "../common/entityInterface";
export interface IUpdatePasswordPartialFormProps {
    open: boolean;
    ...
    showWebRequest: (
        id: string,
        token: string
    ) => Promise<AxiosResponse<baseResponse<PasswordPartial>, any>>;
    updateWebRequest: (
        id: string,
        value: any,
        token: string
...
export const UpdatePasswordPartialForm = (
    props: IUpdatePasswordPartialFormProps
) => {
    ...
    const {
        ...
        handleSubmit,
        setValue,
    } = useForm<IUpdatePasswordPartialDto>({
        resolver: joiResolver(VUpdatePasswordPartialDto),
        defaultValues: {
            message: "",
        },
    });
    ...
    const localHandleSubmit = async (value: IUpdatePasswordPartialDto) => {
        setLoading(true);
