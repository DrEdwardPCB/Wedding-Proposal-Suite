...
import {
    ICreateDestinationPartialDto,
    VCreateDestinationPartialDto,
} from "../../apis/admin";
import {
    Button,
    Dialog,
...
export interface ICreateDestinationPartialFormProps {
    open: boolean;
...
export const CreateDestinationPartialForm = (
    props: ICreateDestinationPartialFormProps
) => {
    ...
    const {
        ...
        reset,
        handleSubmit,
    } = useForm<ICreateDestinationPartialDto>({
        resolver: joiResolver(VCreateDestinationPartialDto),
        defaultValues: {
            message: "",
        },
    });
    const localHandleSubmit = async (value: ICreateDestinationPartialDto) => {
        setLoading(true);
